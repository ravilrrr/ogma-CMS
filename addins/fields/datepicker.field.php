...
class Datepicker
{
	...
	function Datepicker($name, $label, $type, $options,$value='', $help='')
	{
		...
		case "edit":
			...
			$this->value .= '    <input data-format="'.$dateformat.'"  id="'.$name.'" name="'.$name.'"  class="form-control" type="text" value="'.Core::date($value, false).'"></input>';
			...
			$this->value .= '      pickTime: false, format: "'.$dateformat.'"' ;
			$this->value .= '    });';
			$this->value .= '  });';
			$this->value .= '</script>';
			break;
		...
		case "create":
			...
			$this->value .= '  <div id="datetimepicker-'.$name.'" class="input-group">';
			$this->value .= '    <input data-format="'.$dateformat.'"  id="'.$name.'" name="'.$name.'"  class="form-control" type="text" value="'Core::date(date('U'), false).'"></input>';
			$this->value .=  '    <span class="input-group-addon">';
			$this->value .=  '      <span class="glyphicon glyphicon-calendar" data-time-icon="glyphicon-time" data-date-icon="glyphicon-calendar">';
			$this->value .=  '      </span>';
			$this->value .=  '    </span>';
		...
		// -------------------------------------------------
		default:
	        $this->value = Core::date($value, false);
			break;
		}			
	}
} // End 
