...
class Int
{
	...
	function Int($name, $label, $type, $options,$value='',$help='')
	{
		...
		switch($action)
		{
			...
			case "edit":
				...
				$this->value .= '	<input type="text" class="form-control" id="'.$name.'" name="'.$name.'" placeholder="'.$label.'"  class="input-xlarge '.$class.'" value="'.$value.'">';
