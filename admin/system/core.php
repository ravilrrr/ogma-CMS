<?php
defined('IN_OGMA') or die('No direct script access.');
...
class Core {
    ...
    public static $schema = array("blog" => array('slug', 'title', 'pubdate', 'author', 'tags', 'status', 'comments', 'metat', 'metad', 'metak', 'content', 'category', 'image', 'id'), "components" => array('slug', 'content', 'active', 'desc', 'id'), "galleries" => array('galleryname', 'id'), "menus" => array('menuname', 'id'), "pages" => array('slug', 'parent', 'title', 'pubdate', 'route', 'template', 'metat', 'metak', 'metad', 'robots', 'status', 'private', 'content', 'author', 'id'), "routes" => array('route', 'slug', 'desc', 'page', 'id'), "snippets" => array('slug', 'content', 'active', 'desc', 'id'), "users" => array('username', 'password', 'email', 'role', 'firstname', 'lastname', 'id', 'language', 'perms', 'reset', 'salt'), "media" => array('id', 'title', 'alt', 'caption', 'description', 'fileurl', 'tag', 'showorder'), "themehooks" => array('id', 'hook', 'type', 'action'), "customfields" => array('id', 'name', 'table', 'type', 'cache', 'desc', 'options'));
    ...
    public function __construct() {
        ...
        if (Core::getFilenameId() == 'settings' && self::getAction() == "update") {
            ...
            $ret = self::saveSettings();
            if ($ret) {
                Core::addAlert(Form::showAlert('success', __("UPDATED", array(
                    ":record" => "",
                    ":type" => __("SETTINGS")
                ))));
                
            } else {
                Core::addAlert(Form::showAlert('error', __("UPDATEDFAIL", array(
                    ":record" => "",
                    ":type" => __("SETTINGS")
                ))));
