...
Stylesheet::add("../3rdparty/bootstrap-notify/bootstrap-notify.css","backend",11);
...
Scripts::add("../3rdparty/bootstrap-notify/bootstrap-notify.js","backend",20);


Actions::addAction('admin-header','Scripts::show',1,array('backend'));

Actions::addAction('index-header','Stylesheet::show',1,array('frontend'));
Actions::addAction('index-header','Scripts::show',1,array('frontend'));
Actions::addAction('index-footer','Scripts::show',1,array('frontend',true));
