...
class Ogmaeditor{
	...
	public static $maintoolbar = array(
		'h1' => array('name'=>'H1', 'text'=>"H1" , 'icon'=>'' , 'insertBefore'=>'#', 'insertAfter'=>'', 'modal'=>''),
		'h2' => array('name'=>'H2', 'text'=>"H2" , 'icon'=>'' , 'insertBefore'=>'##', 'insertAfter'=>'', 'modal'=>''),
		'h3' => array('name'=>'H3', 'text'=>"H3" , 'icon'=>'' , 'insertBefore'=>'###', 'insertAfter'=>'', 'modal'=>''),
		'bold' => array('name'=>'bold', 'text'=>"" , 'icon'=>'fa:fa fa-fw fa-bold' , 'insertBefore'=>'_', 'insertAfter'=>'_', 'modal'=>''),
		'italic' => array('name'=>'italic', 'text'=>"" , 'icon'=>'fa:fa fa-fw fa-italic' , 'insertBefore'=>'*', 'insertAfter'=>'*', 'modal'=>''),
		'quote' => array('name'=>'quote', 'text'=>"" , 'icon'=>'fa:fa fa-fw fa-quote-right' , 'insertBefore'=>'> ', 'insertAfter'=>'', 'modal'=>''),
		'link' => array('name'=>'link', 'text'=>"" , 'icon'=>'fa:fa fa-fw fa-link' , 'insertBefore'=>"[", 'insertAfter'=>']()', 'modal'=>'')
    ...
    public static function addButton($name, $text, $icon, $insertBefore, $insertAfter, $modal=''){
    	Ogmaeditor::$maintoolbar[$name] = array('name'=>$name, 'text'=>$text , 'icon'=>$icon , 'insertBefore'=>$insertBefore, 'insertAfter'=>$insertAfter,'modal'=>$modal); 
    }
