    ...
    private function showFiles($folder){
        ...
        foreach($folder as $file){ 
            ...
            if (self::checkIfImage($file['name'])){
                $media = '<a class="new-media" data-toggle="tooltip" data-placement="top" title="'.__("ADDMEDIA").'" data-fileurl="'.self::getRelPath().$file['name'].'" ><i class="fa fa-fw fa-picture-o"></i></a>&nbsp;';
            } else {
                $media='';
            }
